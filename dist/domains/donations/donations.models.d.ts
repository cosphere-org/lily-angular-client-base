 ...
 */
export declare enum CheckIfCanAttemptDonationQueryEvent {
    CLOSE = "CLOSE",
    RECALL = "RECALL",
    START = "START",
}
 ...
 */
export declare enum CreateAnonymousDonationResponseCurrency {
    PLN = "PLN",
}
export declare enum CreateAnonymousDonationResponseProductType {
    DONATION = "DONATION",
...
export declare enum CreateAnonymousDonationResponseStatus {
    CANCELED = "CANCELED",
    COMPLETED = "COMPLETED",
    NEW = "NEW",
    PENDING = "PENDING",
 ...
 * https://bitbucket.org/goodai/cosphere-auth-service/src/09d74e1c1f6871739268cd74315b4f114592af2c/cosphere_auth_service/payment/serializers/payment.py/#lines-9
 */
export declare enum CreateDonationResponseCurrency {
    PLN = "PLN",
}
export declare enum CreateDonationResponseProductType {
    DONATION = "DONATION",
    SUBSCRIPTION_LEARNER_MONTHLY = "SUBSCRIPTION_LEARNER_MONTHLY",
    SUBSCRIPTION_LEARNER_YEARLY = "SUBSCRIPTION_LEARNER_YEARLY",
    SUBSCRIPTION_MENTOR_MONTHLY = "SUBSCRIPTION_MENTOR_MONTHLY",
...
export declare enum CreateDonationResponseStatus {
    CANCELED = "CANCELED",
    COMPLETED = "COMPLETED",
    NEW = "NEW",
    PENDING = "PENDING",
 ...
 * https://bitbucket.org/goodai/cosphere-auth-service/src/09d74e1c1f6871739268cd74315b4f114592af2c/cosphere_auth_service/payment/views/donation.py/#lines-184
 */
export declare enum CreateDonationattemptBodyEvent {
    CLOSE = "CLOSE",
    RECALL = "RECALL",
    START = "START",
}
 ...
 */
export declare enum CreateDonationattemptResponseEvent {
    CLOSE = "CLOSE",
    RECALL = "RECALL",
    START = "START",
}
